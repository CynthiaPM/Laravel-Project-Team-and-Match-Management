...
<h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Edit your team here!</h2>
    ...
    <div class="mt-8 mb-20 sm:mx-auto sm:w-full sm:max-w-md shadow-xl rounded flex flex-col justify-center py-12 px-6 lg:px-8 z-10 bg-opacity-0">
        <div class="bg-white py-8 px-6 rounded-lg sm:px-10">
            <form action="{{route('games.update',$game)}}" method="POST" class="mb-0 space-y-6 w-full h-full p-0">
            @csrf
            @method('put')
            ...
            <div class="block text-sm font-medium text-gray-700">
                <label>City/Stadium
                    <div class="mt-4">
                        <input type="text" name="city" value="{{$game->city}}" class="border-0 font-light  border-b rounded-sm w-full h-10"></div>
                </label>
            </div>
            ...
            <div class="flex justify-center "> 
                <a href="{{route('teams.show',$game->team_id)}}">
