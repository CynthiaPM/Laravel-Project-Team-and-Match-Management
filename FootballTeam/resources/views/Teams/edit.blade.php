        ...
        <div class="bg-white py-8 px-6 rounded-lg sm:px-10">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700">
                    Team name:                
                    <div class="mt-4">
                        <input type="text" name="name" value="{{$team->name}}" class="border-0  border-b rounded-sm w-full h-10"></div>
                </label>
                @error('name')
                <small>{{$message}}</small>                
                @enderror
            ...
            <div class="block text-sm font-medium text-gray-700">
                <label>Biography
                    <div class="mt-4">
                        <textarea name="bio"  rows="5"  class="border-0  border-b rounded-sm w-full h-30">{{$team->bio}}  
                        </textarea></div>
                </label>
                @error('bio')
                <small>{{$message}}</small>
